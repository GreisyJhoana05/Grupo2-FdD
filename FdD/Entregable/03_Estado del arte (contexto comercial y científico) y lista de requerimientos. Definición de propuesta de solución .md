...
<img src="https://semanadelcannabis.cayetano.edu.pe/assets/img/logo-upch.png" width="200">                     <p align="left">  <img src="https://github.com/GreisyJhoana05/Grupo2-FdD/blob/main/FdD/Imagenes/ODS/E00Imagen03.jpg?raw=true" width="200">
</p>
...
| ------------ |
| <p align="justify">**US20200376424A1** - Sistema de filtración de aire de partículas de alta eficiencia.<br>**Fecha de Publicación:** 03/12/2020<br>**Inventor(es):** Craig Morse, Ross Trzcinski<br></p>Figura 2:<p align="center"><img src="https://github.com/GreisyJhoana05/Grupo2-FdD/blob/main/FdD/Imagenes/Estado_del_Arte/E03Imagen02.jpg" width="550" style="margin: auto;"></p></p><p align="justify">Este sistema de filtración de aire está diseñado para controlar la liberación de aire filtrado mediante un filtro altamente eficiente de partículas, con el objetivo de reducir la perturbación de las partículas ya depositadas, como los contaminantes irritantes o peligrosos, en el entorno circundante. Después de ser filtrado, el aire se dirige hacia una salida especial que controla su movimiento para evitar que las partículas contaminantes se vuelvan a dispersar en el ambiente. En resumen, este sistema de filtración ayuda a mantener un ambiente más limpio y saludable al controlar la liberación del aire filtrado.<br><br><br></p>|
